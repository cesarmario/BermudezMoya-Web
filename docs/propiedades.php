            ...
            <div class="row mb-4">
                ...
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4 ml-md-4">
                        ...
                        <ul class="list-unstyled">
                            <li>
                                <a href="http://www.corredoresinmobiliariossj.org/#!/-inicio/" target="_blank"><span class="icon-chevron-circle-right mr-2"></span>C.P.C.I.S.J.</a>
                            </li>
                            <li>
                                <a href="https://www.enlaceinmobiliario.com.ar/" target="_blank"><span class="icon-chevron-circle-right mr-2"></span>Enlace
                                    Inmobiliario</a>
                            </li>
                            <li>
                                <a href="http://www.crsargentina.com.ar/" target="_blank"><span class="icon-chevron-circle-right mr-2"></span>CRS Argentina</a>
                            </li>
                            <li>
                                <a href="#"><span class="icon-chevron-circle-right mr-2"></span>Preguntas
                                    Frecuentes</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-md">
                    <div class="ftco-footer-widget mb-4 ml-md-4">
                        ...
                        <ul class="list-unstyled">
                            <li>
                                <a href="nosotros.html"><span class="icon-chevron-circle-right mr-2"></span>Nosotros</a>
                            </li>
                            <li>
                                <a href="servicios.html"><span class="icon-chevron-circle-right mr-2"></span>Servicios</a>
                            </li>
                            <li>
                                <a href="agentes.html"><span class="icon-chevron-circle-right mr-2"></span>Agentes</a>
                            </li>
                            <li>
                                <a href="propiedades.php"><span class="icon-chevron-circle-right mr-2"></span>Propiedades</a>
                            </li>
                            <li>
                                <a href="contacto.html"><span class="icon-chevron-circle-right mr-2"></span>Contacto</a>
                            </li>
                            <li>
                                <a href="gestion/"><span class="icon-chevron-circle-right mr-2"></span>Gestion</a>
                            </li>
                        </ul>
                    </div>
                </div>
